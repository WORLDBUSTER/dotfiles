...
# original source: https://github.com/Icelk/dotfiles/blob/main/scripts/playerctl-custom.sh
...
# If there was nothing to pause (we would've `exit`ed), play from the preferred player.
pctl $(pref_spt) "Play"
